...
--- | --- | --- | ---
[account_asset_operating_unit](account_asset_operating_unit/) | 14.0.1.0.0 | [![ps-tubtim](https://github.com/ps-tubtim.png?size=30px)](https://github.com/ps-tubtim) | This module adds operating unit information to assets.

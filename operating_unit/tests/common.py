...
class OperatingUnitCommon(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        # B2C Operating Unit
        cls.b2c = cls.env["operating.unit"].create(
            {"name": "B2C", "code": "B2C", "partner_id": cls.partner.id}
        )
        # B2B Operating Unit
        cls.b2b = cls.env["operating.unit"].create(
            {"name": "B2B", "code": "B2B", "partner_id": cls.partner.id}
        )

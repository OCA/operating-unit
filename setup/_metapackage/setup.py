...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-account_asset_transfer_operating_unit>=15.0dev,<15.1dev',
        ...
        'odoo-addon-purchase_deposit_operating_unit>=15.0dev,<15.1dev',
        'odoo-addon-purchase_operating_unit>=15.0dev,<15.1dev',
        'odoo-addon-purchase_operating_unit_access_all>=15.0dev,<15.1dev',

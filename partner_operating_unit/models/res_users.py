...
class ResUsers(models.Model):
    ...
    def create(self, vals):
        ...
        """
        res = super(ResUsers, self.with_context(copy_ou_to_partner=True)).create(vals)
    ...
    def create(self, vals_list):
        """ operating_unit_ids is defined also on the res.partner, and
            ...
            doesn't propagate the values. Thus we do it manually.
        """
        users = super(ResUsers, self.with_context(copy_ou_to_partner=True)).create(vals_list)
        for user in users:
    ...
    def write(self, vals):
        """ operating_unit_ids is defined also on the res.partner, and
            ...
            doesn't propagate the values. Thus we do it manually.
        """
        res = super(ResUsers, self.with_context(copy_ou_to_partner=True)).write(vals)

...
* The user’s default Operating Unit (OU) is proposed at the time of creating the Employee.

* Security rules are defined to ensure that users can only see the Employee of that Operating Units in which they are allowed access to.

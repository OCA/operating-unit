...
This module extends operating unit of OCA to add sequence of an operating unit in all documents. ie. Sale orders, Delivery and Receipts, Purchase orders etc.
...
#. Install module
#. Edit Sequence records by adding Operating Unit.
#. Set Default Operating Unit of User.
#. Create a Sale Order and sequence will be generated based on the user's default operating unit.
...
* Kevin Kamaa <kevin@sunflowerweb.nl>

...
class TestStockOperatingUnit(common.TestStockCommon, OperatingUnitCommon):
    ...
    def setUpClass(cls):
        ...
        cls.stock_location.write({"operating_unit_id": cls.ou1.id})
    ...
    def test_create_warehouse_for_company_without_operating_unit(self):
        warehouse = self.WarehouseObj.create(
            {
                "name": "Second Company Warehouse Test",
                "code": "SCWHT",

    ...
    def _register_hook(self):
        ...
        def _create_payment_entry(self, amount):
            ...
            if self.payment_difference_handling == 'reconcile' and self.payment_difference:
                ...
                writeoff_line['operating_unit_id'] = counterpart_aml_dict['operating_unit_id']
        ...
        origin = getattr(AccountPaymentOrig._create_payment_entry, 'origin', None)
        if origin != _create_payment_entry:
            AccountPaymentOrig._patch_method('_create_payment_entry', _create_payment_entry)
